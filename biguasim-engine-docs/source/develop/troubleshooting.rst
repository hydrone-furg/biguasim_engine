...
This page contains answers to common questions or issues that may occur as you try to develop BiguaSim. 
...
Try clicking on the ``Biguasim.uproject`` file again and saying "yes" to rebuild if prompted. 
...
There are some errors in the Unreal Engine source code that also could be preventing issues. These files can be changed without affecting BiguaSim. 


None of my changes to code are showing up when I run BiguaSim
--------------------------------------------------------------

If you changed any c++ files, you must compile BiguaSim either from from the Unreal Engine editor, or from Visual Studio.
Please see :ref:`develop-compiling`. 

If you changed any python files, you must go to ``biguasim`` and run ``pip install .``
