...
#include "HuauvControlThrusters.generated.h"

/**
* UHuauvControlThrusters
*/
UCLASS()
class HOLODECK_API UHuauvControlThrusters : public UHolodeckControlScheme {
public:
	GENERATED_BODY()

	UHuauvControlThrusters(const FObjectInitializer& ObjectInitializer);
	...
	*/
	...
	void SetController(AHolodeckPawnController* const Controller) { HuauvController = Controller; };

private:
	AHolodeckPawnController* HuauvController;
	AHuauv* Huauv;
