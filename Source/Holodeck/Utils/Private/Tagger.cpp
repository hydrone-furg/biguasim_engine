...
holoocean::ObjectLabel ATagger::GetLabelByFolderName(const FString& String)
{
	...
	else if (String == "Sky") return holoocean::ObjectLabel::Sky;
	else if (String == "Bridge") return holoocean::ObjectLabel::Bridge;
	else if (String == "Water") return holoocean::ObjectLabel::Water;
...
#define HOLOOCEAN_GET_LABEL_STR(lbl) case holoocean::ObjectLabel:: lbl : return TEXT(#lbl);
	default:
		...
		HOLOOCEAN_GET_LABEL_STR(Sky)
		HOLOOCEAN_GET_LABEL_STR(Bridge)
		HOLOOCEAN_GET_LABEL_STR(Water)
