...
void UAddSensorCommand::Execute() {
	...
	static USensorMapType SensorMap = {
		{ "CollisionSensor", UCollisionSensor::StaticClass() },
		...
		{ "CameraSensor", UCameraSensor::StaticClass()},
		{"RGBDCamera", URGBDCamera::StaticClass()},
		...
		{"FOVDetection", UDetectionComponent::StaticClass()},
		{"AnnotationComponent", UAnnotationComponent::StaticClass()},
		{"DepthCamera", UDepthCamera::StaticClass()}
		// {"Annotation", UAnnotationCamSensor::StaticClass()}
